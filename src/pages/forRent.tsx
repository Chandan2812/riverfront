    ...
    <div className="bg-white text-black dark:bg-black dark:text-white">
      ...
      <div className="w-full md:w-[90%] mx-auto p-3 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6 min-h-screen">
        {filteredProperties.map((property, index) => (
          <div
            key={index}
            className="border border-gray-300 dark:border-gray-700 rounded-xl hover:shadow-[var(--primary-color)] shadow-md overflow-hidden cursor-pointer transition hover:scale-105"
            onClick={() =>
          ...
          >
            ...
            <div className="py-4 px-4 space-y-4">
              ...
              <div className="flex justify-between text-sm text-gray-800 dark:text-gray-200 mb-2 font-raleway font-light dark:font-thin">
              ...
              <div className="flex gap-10 text-gray-800 dark:text-gray-200 justify-between mb-3">
