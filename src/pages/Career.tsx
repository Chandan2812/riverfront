  ...
  return (
    <div className="bg-white dark:bg-black text-black dark:text-white font-raleway font-light dark:font-thin">
      ...
      <div className="w-full md:w-[90%] mx-auto px-6 pb-12 text-center">
        {/* Header Section */}
        <h1 className="text-3xl text-[var(--primary-color)] font-bold mb-4">
          Join An Award-winning Team
        </h1>
        <p className="text-md font-light mb-8">
          RIVERFRONT, one of the top real estate firms in Dubai, has seen an
          upward trend in the buying of luxury properties within the UAE. Over
          the first half of the year, Dubai recorded an 18% increase in
          high-net-worth individuals (FINWIs).
        </p>

        {/* Contact Information - Two Column Layout */}
        <h2 className="text-2xl text-[var(--primary-color)] font-semibold mb-3 text-center">
          Why Join Us?
        </h2>
        <div className="w-full grid md:grid-cols-2 gap-4 text-left">
          <p className=" mb-4">
            Established in 2008, we have helped thousands of people from all
            over the world find their dream home and benefit from some of the
            best real estate investments available in Dubai.
          </p>
          <p className=" mb-4">
            Offering a wide range of professional services to buyers, sellers,
            landlords and tenants, we provide our clients with honest impartial
            advice and the highest levels of customer service.
          </p>
          <p className=" mb-4">
            Over the years we have won a plethora of prestigious awards from
            leading developers across the UAE, Including Emaar, Dubai Holding,
            Meraas, Damac, Nakheel, Aldar and many more. Click here to find out
            more.{" "}
          </p>
          <p className=" mb-4">
            With exciting expansion plans on the horizon, we are looking to fill
            a variety of newly created roles in the near future.{" "}
          </p>
        </div>
        ...
        <div className="mt-12 w-full md:w-2/3 text-center mx-auto flex flex-col">
          ...
          <p className=" mt-2">
            ...
            on the role to view the full job description and apply with your CV
            and cover letter.
          </p>
          <i className="">Good Luck!</i>
        </div>
      </div>
      ...
      <div className="flex justify-center items-center w-5/6 mx-auto px-6 py-8 text-center rounded-lg mb-7">
        <div className="w-full max-w-lg bg-gray-100 dark:bg-neutral-900 rounded-lg p-8 text-center">
          ...
          <form
            ...
            className="space-y-3 text-black font-sans"
          >
            {/* Name & Email */}
            <input
              type="text"
            ...
            <div className="w-full">
              <PhoneInput
                ...
                className="bg-white border border-gray-300 px-4 py-3 text-[16px] rounded-lg w-full focus:ring-2 focus:ring-black"
              />
            </div>
