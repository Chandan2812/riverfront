  ...
  return (
    <div>
      ...
      <div className="relative">
        <img src={forsaleImage} alt="" className="h-[400px] w-full object-cover" />
        <div className="  absolute inset-0 bg-black bg-opacity-40 flex items-center justify-start p-8">
          <div className=" text-white">
            ...
            <p className="text-lg mt-2 md:pl-7">{property.location}</p>
          </div>
        </div>
      </div>
      ...
      <div className="w-[90%] mx-auto my-8 grid grid-cols-2 md:grid-cols-5 gap-4">
        {property.images.map((img, idx) => (
          <img key={idx} src={img} alt={`property-${idx}`} className="  rounded-xl h-60 object-cover w-full" />
        ))}
      </div>
{/* Property Overview */}
<div className="w-[90%] mx-auto my-10 grid grid-cols-1 sm:grid-cols-2 gap-4 text-gray-800 text-base">
  ...
  <div className="flex items-center gap-3">
    ...
    <span className="font-semibold text-black ml-2">{property.propertyType}</span>
  </div>
  ...
  <div className="flex items-center gap-3">
    ...
    <span className="font-semibold text-black ml-2">{property.areaSqft} Sq Ft</span>
  </div>
  ...
  <div className="flex items-center gap-3">
    ...
    <span className="font-semibold text-black ml-2">{property.bedrooms} Bed</span>
  </div>
  ...
  <div className="flex items-center gap-3">
    ...
    <span className="font-semibold text-black ml-2">{property.bathrooms} Baths</span>
  </div>
</div>
