  ...
  return (
    <div className="relative h-screen overflow-hidden">
      ...
      <div className="absolute inset-0 z-20 flex flex-col items-center justify-center text-white text-center px-4">
        ...
        <div className="mt-10 bg-white/90 p-4 md:p-6 rounded-xl shadow-xl w-[90%] md:w-[80%] lg:w-[60%] mx-auto text-black font-raleway">
          {/* Tabs */}
          ...
          <div className="flex flex-wrap items-end gap-4 justify-between">
            ...
            <div className="flex-1 min-w-[100px]">
              <label className="block text-sm text-gray-700 mb-1">Beds</label>
              <div className="relative">
                <select className="w-full border rounded px-3 py-2 pr-8 appearance-none focus:outline-none focus:ring-1 focus:ring-[var(--primary-color)]">
                  <option>1</option>
                  <option>2</option>
