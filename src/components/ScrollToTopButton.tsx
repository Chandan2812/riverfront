...
const ScrollToTopButton = () => {
  ...
  return (
    <button
      onClick={scrollToTop}
      className={`hidden md:flex fixed bottom-3 right-6 w-12 h-12 rounded-full bg-white shadow-lg items-center justify-center z-50 transition-opacity duration-300 ${
