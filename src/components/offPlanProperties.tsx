...
const properties = [
  {
    ...
    image:
      "https://uniqueproperties.ae/en/uploads/frontend/projects/615034/conversions/verdes-by-haven-2-resize.webp",
  },
  ...
  return (
    <div className="w-full">
      ...
      <div
        ...
        style={{
          backgroundImage:
            "url('https://uniqueproperties.ae/en/frontend/assets/images/banner/homeBg.webp')",
        }}
      >
        ...
        {properties.map((property) => (
          ...
          >
            ...
            <div className="p-3">
              ...
              <button className="mt-2 bg-gray-200 p-2 rounded-md w-full">
                View Details
              </button>
            </div>
          </div>
